// flow-typed signature: bede10fe2582e66d411a59e4c4a46ad3
// flow-typed version: <<STUB>>/recompose_v^0.23.1/flow_v0.43.1
...
declare module 'recompose' {
  declare module.exports: {
    withProps: $Exports<'recompose/withProps'>
  };
}
...
declare module 'recompose/withProps' {
  declare function WithPropsHigherOrderComponent<
    InputProps,
    TotalProps
  >(
    baseComponent: Class<React$Component<InputProps, TotalProps, *>>
  ): Class<React$Component<void, InputProps, void>>

  declare function withProps<
    CreatePropsOutputProps: {},
    TotalProps: {},
    InputProps: $Diff<TotalProps, CreatePropsOutputProps>
  >(
    createProps: (ownerProps: InputProps) => CreatePropsOutputProps
  ): (baseComponent: Class<React$Component<InputProps, TotalProps, *>>) => Class<React$Component<void, InputProps, void>>

  declare module.exports: typeof withProps;
}
